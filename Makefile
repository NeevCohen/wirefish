...
LIBSNIFF_SOURCES := $(LIBSNIFF_DIR)/sniffer.cpp $(LIBSNIFF_DIR)/capture.cpp $(LIBSNIFF_DIR)/ethernet_frame.cpp $(LIBSNIFF_DIR)/ip_packet.cpp $(LIBSNIFF_DIR)/tcp_frame.cpp $(LIBSNIFF_DIR)/udp_datagram.cpp $(LIBSNIFF_DIR)/arp_packet.cpp
LIBSNIFF_HEADERS := $(LIBSNIFF_DIR)/libsniff.h $(LIBSNIFF_DIR)/sniffer.h $(LIBSNIFF_DIR)/capture.h $(LIBSNIFF_DIR)/ethernet_frame.h $(LIBSNIFF_DIR)/ip_packet.h $(LIBSNIFF_DIR)/tcp_frame.h $(LIBSNIFF_DIR)/udp_datagram.h $(LIBSNIFF_DIR)/arp_packet.h
